...
<html lang="en" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <div class="jumbotron container border border-info">
            <h3>Update Existing Shoes</h3>
            <form action="/admin/shoes/updating_shoes/${detailShoes.shoesId}" method="post">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                <div class="row">
                    <div class="col-sm-5">

                        <div class="form-group">
                            <label for="shoesId">Shoes Id</label> 
                            <input type="number" readonly="readonly" class="form-control border border-success" name="shoesId"  value="${detailShoes.shoesId}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control border border-success" 
                                   required name="price" value="${detailShoes.price}" 
