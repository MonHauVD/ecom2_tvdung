                ...
                <tbody>
                    <c:forEach var="order" items="${orders.lsOrder}" varStatus="status">
                        <tr>
                            ...
                            <td>
                                <c:if test="${order.state == 'WaitingForConfirm'}">
                                    <button type="button" class="btn btn-success" onclick="window.location.href = 'processed_order/${order.id}'">
                                        Confirm processed!
                                    </button>
                                </c:if>
                            </td>
                            <td>
                                <c:if test="${order.state == 'Received'}">
                                    <button type="button" class="btn btn-success" onclick="window.location.href = 'paid_order/${order.id}'">
                                        Confirm Paid!
                                    </button>
                                </c:if>
                            </td>
