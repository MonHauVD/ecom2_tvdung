...
<html lang="en" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <div class="jumbotron container border border-info">
            <h3>Update Existing Laptop</h3>
            <form action="/admin/laptop/updating_laptop/${detailLaptop.laptopId}" method="post">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" readonly="readonly" class="form-control border border-success" name="laptopId"  value="${detailLaptop.laptopId}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control border border-success" 
                                   required name="price" value="${detailLaptop.price}" 
