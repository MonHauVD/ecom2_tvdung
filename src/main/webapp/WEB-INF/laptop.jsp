...
<body class="bg-light">
	...
	<div class="container-fluid">
		...
		<a style="margin: 20px 0" class="btn btn-primary"
			href="/admin/laptop/add">Add laptop</a><br>
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td>
                                            <a class="nav-link" href="laptop/delete_laptop/${laptop.laptopId}" >Delete</a>
                                        </td>
                                        <td>
                                            <a class="nav-link" href="laptop/update_laptop/${laptop.laptopId}" >Update</a>
                                        </td>
